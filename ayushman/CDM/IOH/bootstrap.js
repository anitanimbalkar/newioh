...
Ext.ClassManager.addNameAlternateMappings({
  "Ayushman.common.baseclasses.controller.AbstractBaseController": [],
  "Ayushman.common.baseclasses.controller.BaseController": [],
  "Ayushman.common.baseclasses.model.BaseModel": [],
  "Ayushman.common.baseclasses.store.BaseLocalStore": [],
  "Ayushman.common.baseclasses.store.BaseRemoteStore": [],
  "Ayushman.common.baseclasses.store.BaseStore": [],
  "Ayushman.common.baseclasses.view.AbstractBaseView": [],
  "Ayushman.common.baseclasses.view.BaseView": [],
  "Ayushman.common.components.DBDropdown": [],
  "Ayushman.common.components.GenericDBDropDown": [],
  "Ayushman.controller.IohFrameController": [],
  "Ayushman.controller.LoginController": [],
  "Ayushman.controller.cdm.CdmPatientsListController": [],
  "Ayushman.controller.cdm.CreateRegimenController": [],
  "Ayushman.controller.cdm.CreateRegimenFinishedPageController": [],
  "Ayushman.controller.cdm.DoctorCdmHomeController": [],
  "Ayushman.controller.cdm.DrillDownFiltersContainerController": [],
  "Ayushman.controller.cdm.PatientDetailsController": [],
  "Ayushman.controller.cdm.PreviousRegimenController": [],
  "Ayushman.controller.cdm.SelectPeriodAndGoalForRegimenController": [],
  "Ayushman.controller.cdm.SendSmsController": [],
  "Ayushman.controller.cdm.components.DrillDownContextMenuController": [],
  "Ayushman.controller.cdm.components.DrillDownFilterComponentController": [],
  "Ayushman.controller.cdm.components.DrillDownGraphController": [],
  "Ayushman.controller.cdm.components.FilteredPatientListItemComponentController": [],
  "Ayushman.controller.cdm.components.InstructionHolderController": [],
  "Ayushman.controller.cdm.components.PatientsGeneralInfoKeyValueComponentController": [],
  "Ayushman.controller.cdm.components.PreviousPlansListItemComponentController": [],
  "Ayushman.controller.cdm.components.SingleInstructionContainerController": [],
  "Ayushman.controller.ioh.DoctorIohHomeController": [],
  "Ayushman.controller.ioh.PatientIohHomeController": [],
  "Ayushman.model.DrillDownGraphModel": [],
  "Ayushman.model.LoginModel": [],
  "Ayushman.model.UserCredentials": [],
  "Ayushman.model.cdm.CreateRegimenModel": [],
  "Ayushman.model.cdm.DrillDownConfigurationModel": [],
  "Ayushman.model.cdm.DrillDownDimensionModel": [],
  "Ayushman.model.cdm.DrillDownPatientSummaryModel": [],
  "Ayushman.model.cdm.DrillDownTimeFrameModel": [],
  "Ayushman.model.cdm.GenericConstant": [],
  "Ayushman.model.cdm.InstructionParametersModel": [],
  "Ayushman.model.cdm.InstructionType": [],
  "Ayushman.model.cdm.PatientsGeneralDetailsModel": [],
  "Ayushman.model.cdm.PatientsPlanDetailsModel": [],
  "Ayushman.model.cdm.SingleInstructionContainerModel": [],
  ...
  "Ayushman.store.cdm.InstructionTypes": [],
  ...
  "Ayushman.util.Config": [],
  "Ayushman.view.IohFrameView": [],
  "Ayushman.view.LoginView": [],
  "Ayushman.view.cdm.CdmPatientsListView": [],
  "Ayushman.view.cdm.CreateRegimenFinishedPageView": [],
  "Ayushman.view.cdm.CreateRegimenView": [],
  "Ayushman.view.cdm.DoctorCdmHomeView": [],
  "Ayushman.view.cdm.DrillDownFiltersContainerView": [],
  "Ayushman.view.cdm.PatientDetailsView": [],
  "Ayushman.view.cdm.PreviousRegimenView": [],
  "Ayushman.view.cdm.SelectPeriodAndGoalForRegimenView": [],
  "Ayushman.view.cdm.SendSmsView": [],
  "Ayushman.view.cdm.components.DrillDownBarChartComponent": [],
  "Ayushman.view.cdm.components.DrillDownContextMenuView": [],
  "Ayushman.view.cdm.components.DrillDownFilterComponentView": [],
  "Ayushman.view.cdm.components.DrillDownGraphView": [],
  "Ayushman.view.cdm.components.FilteredPatientListItemComponentView": [],
  "Ayushman.view.cdm.components.InstructionHolderView": [],
  "Ayushman.view.cdm.components.PatientsGeneralInfoKeyValueComponentView": [],
  "Ayushman.view.cdm.components.PreviousPlansListItemComponentView": [],
  "Ayushman.view.cdm.components.SingleInstructionContainerView": [],
  "Ayushman.view.cdm.instructions.BodyWeightBasedExerciseInstruction": [],
  "Ayushman.view.cdm.instructions.CalorieBasedNutritionInstruction": [],
  "Ayushman.view.cdm.instructions.DurationBasedInstruction": [],
  "Ayushman.view.cdm.instructions.FoodBasedNutritionInstruction": [],
  "Ayushman.view.cdm.instructions.HealthParamWithGoalInstruction": [],
  "Ayushman.view.cdm.instructions.HomeBasedTestInstruction": [],
  "Ayushman.view.cdm.instructions.LabBasedHealthParamInstruction": [],
  "Ayushman.view.cdm.instructions.WeightBasedExerciseInstruction": [],
  "Ayushman.view.ioh.DoctorIohHomeView": [],
  "Ayushman.view.ioh.PatientIohHomeView": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Ayushman.controller.cdm.SendSmsController": [],
  "Ayushman.controller.cdm.components.DrillDownContextMenuController": [
    "widget.drilldowncontextmenucontroller"
  ],
  "Ayushman.controller.cdm.components.DrillDownFilterComponentController": [],
  "Ayushman.controller.cdm.components.DrillDownGraphController": [
    "widget.drilldowngraphcontroller"
  ],
  "Ayushman.controller.cdm.components.FilteredPatientListItemComponentController": [],
  "Ayushman.controller.cdm.components.InstructionHolderController": [],
  "Ayushman.controller.cdm.components.PatientsGeneralInfoKeyValueComponentController": [],
  ...
  "Ayushman.view.cdm.CdmPatientsListView": [
    "widget.cdmpatientslist"
  ],
  "Ayushman.view.cdm.CreateRegimenFinishedPageView": [
    "widget.createregimenfinishedpageview"
  ],
  "Ayushman.view.cdm.CreateRegimenView": [],
  "Ayushman.view.cdm.DoctorCdmHomeView": [
    "widget.doctorcdmhome"
  ],
  "Ayushman.view.cdm.DrillDownFiltersContainerView": [
    "widget.drilldownfilterscontainer"
  ],
  "Ayushman.view.cdm.PatientDetailsView": [
  ...
  "Ayushman.view.cdm.PreviousRegimenView": [],
  "Ayushman.view.cdm.SelectPeriodAndGoalForRegimenView": [
    "widget.selectperiodandgoalforregimenview"
  ],
  "Ayushman.view.cdm.SendSmsView": [
    "widget.sendsms"
  ],
  "Ayushman.view.cdm.components.DrillDownBarChartComponent": [
    "widget.categorybarchart"
  ],
  "Ayushman.view.cdm.components.DrillDownContextMenuView": [
    "widget.drilldowncontextmenucomponent"
  ],
  "Ayushman.view.cdm.components.DrillDownFilterComponentView": [
    "widget.drilldownfiltercomponent"
  ],
  "Ayushman.view.cdm.components.DrillDownGraphView": [
    "widget.drilldowngraphcomponent"
  ],
  "Ayushman.view.cdm.components.FilteredPatientListItemComponentView": [
    "widget.filteredpatientlistitemcomponent"
  ],
  "Ayushman.view.cdm.components.InstructionHolderView": [
    "widget.instructionHolder"
  ],
  "Ayushman.view.cdm.components.PatientsGeneralInfoKeyValueComponentView": [
    "widget.patientsgeneralinfokeyvaluecomponent"
  ],
  "Ayushman.view.cdm.components.PreviousPlansListItemComponentView": [
    "widget.previousplanslistitemcomponent"
  ],
  "Ayushman.view.cdm.components.SingleInstructionContainerView": [
    "widget.singleInstrContainer"
  ],
  "Ayushman.view.cdm.instructions.BodyWeightBasedExerciseInstruction": [
    "widget.BodyWeightBased"
  ],
  "Ayushman.view.cdm.instructions.CalorieBasedNutritionInstruction": [
    "widget.CalorieBased"
  ],
  "Ayushman.view.cdm.instructions.DurationBasedInstruction": [
    "widget.DurationBased"
  ],
  "Ayushman.view.cdm.instructions.FoodBasedNutritionInstruction": [
    "widget.FoodBased"
  ],
  "Ayushman.view.cdm.instructions.HealthParamWithGoalInstruction": [
    "widget.HealthParamBased"
  ],
  "Ayushman.view.cdm.instructions.HomeBasedTestInstruction": [
    "widget.HomeBased"
  ],
