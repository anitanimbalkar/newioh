...
function assgnheight(){
	var winwidth = $(window).width();
	var winheight = $(window).height();	
	var winheightPatients = $(window).height() - 92;
	$('#subNavigation, #contentarea').css('height', winheight);
	$('#patiensCarousel .carousel-caption').css('height', winheightPatients);
}
