...
<body>
 ...
 <div  style="max-width:900px; width:100%;margin:0px auto 0px auto;" > 
  ...
  <?php if(isset($_COOKIE["header_image"])) {?>
   <img style="width:100%;" src="/<?php echo @$_COOKIE["header_image"]; ?>" alt="header">
   <?php } else { ?>
  ...
  <div >
   ...
   <div style="width:100%;">
    ...
    <div style="float:right;width:25%;margin-left:-50px;">
     ...
     <img  src="/<?php echo @$_COOKIE["signature_image"]; ?>" width="150" alt="middle"/>
	 <?php } else { ?>
  ...
  <div style="width:100%;">
   ...
   <img style="width:100%;" src="/<?php echo @$_COOKIE["footer_image"]; ?>" alt="footer"/>
   <?php } else { ?>
