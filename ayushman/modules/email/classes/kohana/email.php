...
class Kohana_Email {
	 ...
	 */
	public static function send($to, $from, $subject, $message, $html = FALSE,$replyto = null)
	{
	...
	public static function sendwithattachment($to, $from, $subject, $message, $html = FALSE,$path)
	{
		// Connect to SwiftMailer
		(Email::$mail === NULL) and email::connect();
