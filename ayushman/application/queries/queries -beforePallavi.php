...
return array(
	...
	"IPDpatientsService" =>array(
		...
		"query" => 'select C.patid as patid,C.amt as amt,C.tdate as tdate,C.testname as testname,C.refid as refid,C.rcptno as rcptno,C.pdffilename as pdffilename,C.quantity as quantity, C.totalamt as totalamt,C.flag as flag,C.sortdate as sortdate, C.sortdatetime as sortdatetime
					from (
