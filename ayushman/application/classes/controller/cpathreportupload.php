...
class Controller_Cpathreportupload extends Controller {
			...
			if($_FILES["file"]["type"]!="application/pdf")
			{
				if($_FILES["file"]["type"]!="application/octet-stream")
				{
					...
					{  // id is test id
						...
						$objfile->dateoftest_c = date("Y-m-d");					//Insert report details into patienttestreport
				...
				else//dicom
				{
					...
					$dicomfile->dateoftest_c = date("Y-m-d");					//Insert report details into patienttestreport
					$dicomfile->save();
