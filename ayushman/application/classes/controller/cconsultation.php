...
class Controller_Cconsultation extends Controller_Ctemplatewithmenu {
	...
	private function displayDashboard(){
		...
		if ($user->has('roles', ORM::factory('role', array('name' => 'doctor')))){
			...
			{
				$content = View::factory('vhospdoctordashboard');
			}
	...
	public function action_getmyprofile(){
		...
		if ($user->has('roles', ORM::factory('role', array('name' => 'doctor')))){
			...
			$user_info['userinfo']['photoflag'] =$doctor->defphotoflag_c;
			
			
			// Added to select personalise labels to be 
			// printed on prescription
			$docObj =  ORM::factory('doctorpresclb')->where('refdoctorsid_c','=',$doctor_id)->find();
			if ($docObj->id == null)
			{
				$docObj =  ORM::factory('doctorpresclb')->where('refdoctorsid_c','=',-1)->find();
			}	
			$user_info['userinfo']['morning'] =$docObj->mornlabel_c;
			$user_info['userinfo']['afternoon'] =$docObj->aftrlabel_c;
			$user_info['userinfo']['evening'] =$docObj->evenlabel_c;
			$user_info['userinfo']['night'] =$docObj->nigtlabel_c;
			
			
			// Added for Hospital Doctor
			if($doctor->refhospitalid_c == null)
				$user_info['userinfo']['hospitalflag'] =0;
			else
				$user_info['userinfo']['hospitalflag'] =1;
	...
	public function action_getbilldata(){
		...
		$billdata['label1_c']=$objbill->label1_c;
		$billdata['label2_c']=$objbill->label2_c;
		$billdata['label3_c']=$objbill->label3_c;
		$billdata['label4_c']=$objbill->label4_c;
		$billdata['label5_c']=$objbill->label5_c;
		$billdata['label6_c']=$objbill->label6_c;
		$billdata['label7_c']=$objbill->label7_c;
		$billdata['label8_c']=$objbill->label8_c;
		$billdata['label9_c']=$objbill->label9_c;
		$billdata['label10_c']=$objbill->label10_c;
		$billdata['label11_c']=$objbill->label11_c;
		$billdata['label12_c']=$objbill->label12_c;
		$billdata['label13_c']=$objbill->label13_c;
		$billdata['label14_c']=$objbill->label14_c;
		$billdata['label15_c']=$objbill->label15_c;
		$billdata['label16_c']=$objbill->label16_c;
		$billdata['label17_c']=$objbill->label17_c;
		$billdata['label18_c']=$objbill->label18_c;
		$billdata['label19_c']=$objbill->label19_c;
		$billdata['label20_c']=$objbill->label20_c;
		$billdata['label21_c']=$objbill->label21_c;
		$billdata['label22_c']=$objbill->label22_c;
		$billdata['label23_c']=$objbill->label23_c;
		$billdata['label24_c']=$objbill->label24_c;
		$billdata['label25_c']=$objbill->label25_c;
		
	/////// 25 Charges//////////////////////////////
		$billdata['charge1_c']=$objbill->charge1_c;
		$billdata['charge2_c']=$objbill->charge2_c;
		$billdata['charge3_c']=$objbill->charge3_c;
		$billdata['charge4_c']=$objbill->charge4_c;
		$billdata['charge5_c']=$objbill->charge5_c;
		$billdata['charge6_c']=$objbill->charge6_c;
		$billdata['charge7_c']=$objbill->charge7_c;
		$billdata['charge8_c']=$objbill->charge8_c;
		$billdata['charge9_c']=$objbill->charge9_c;
		$billdata['charge10_c']=$objbill->charge10_c;
		$billdata['charge11_c']=$objbill->charge11_c;
		$billdata['charge12_c']=$objbill->charge12_c;
		$billdata['charge13_c']=$objbill->charge13_c;
		$billdata['charge14_c']=$objbill->charge14_c;
		$billdata['charge15_c']=$objbill->charge15_c;
		$billdata['charge16_c']=$objbill->charge16_c;
		$billdata['charge17_c']=$objbill->charge17_c;
		$billdata['charge18_c']=$objbill->charge18_c;
		$billdata['charge19_c']=$objbill->charge19_c;
		$billdata['charge20_c']=$objbill->charge20_c;
		$billdata['charge21_c']=$objbill->charge21_c;
		$billdata['charge22_c']=$objbill->charge22_c;
		$billdata['charge23_c']=$objbill->charge23_c;
		$billdata['charge24_c']=$objbill->charge24_c;
		$billdata['charge25_c']=$objbill->charge25_c;

		/////// 25 Quantity//////////////////////////////
		
		
		$billdata['quantity1_c']=$objbill->quantity1_c;
		$billdata['quantity2_c']=$objbill->quantity2_c;
		$billdata['quantity3_c']=$objbill->quantity3_c;
		$billdata['quantity4_c']=$objbill->quantity4_c;
		
		
		$billdata['quantity5_c']=$objbill->quantity5_c;
		$billdata['quantity6_c']=$objbill->quantity6_c;
		$billdata['quantity7_c']=$objbill->quantity7_c;
		$billdata['quantity8_c']=$objbill->quantity8_c;
		$billdata['quantity9_c']=$objbill->quantity9_c;
		$billdata['quantity10_c']=$objbill->quantity10_c;
		$billdata['quantity11_c']=$objbill->quantity11_c;
		$billdata['quantity12_c']=$objbill->quantity12_c;
		$billdata['quantity13_c']=$objbill->quantity13_c;
		$billdata['quantity14_c']=$objbill->quantity14_c;
		$billdata['quantity15_c']=$objbill->quantity15_c;
		$billdata['quantity16_c']=$objbill->quantity16_c;
		$billdata['quantity17_c']=$objbill->quantity17_c;
		$billdata['quantity18_c']=$objbill->quantity18_c;
		$billdata['quantity19_c']=$objbill->quantity19_c;
		$billdata['quantity20_c']=$objbill->quantity20_c;
		$billdata['quantity21_c']=$objbill->quantity21_c;
		$billdata['quantity22_c']=$objbill->quantity22_c;
		$billdata['quantity23_c']=$objbill->quantity23_c;
		$billdata['quantity24_c']=$objbill->quantity24_c;
		$billdata['quantity25_c']=$objbill->quantity25_c;

		$billdata['reffileid_c']=$objbill->reffileid_c;
		
		
		// Find if receipt made against this bill
		if($objbill->statementcode_c!=null and $objbill->statementcode_c!='')
		{
			$objrcpt=ORM::factory('receipt')->where('billstatementcode_c','=',$objbill->statementcode_c)->find();
			if($objrcpt->id !=null)
			{
				$billdata['amount_c'] =$objrcpt->amount_c;
				$billdata['extradesc_c'] =$objrcpt->extradesc_c;
				$billdata['chequedate_c'] =$objrcpt->chequedate_c;
				$billdata['chequeno_c']= $objrcpt->chequeno_c;
				$billdata['cardtrnxno_c']= $objrcpt->cardtrnxno_c;
				$billdata['refmodeofpayment_c']= $objrcpt->refmodeofpayment_c;
			}
			else
			{
				$billdata['amount_c'] =null;
				$billdata['extradesc_c'] =null;
				$billdata['chequedate_c'] =null;
				$billdata['chequeno_c']= null;
				$billdata['cardtrnxno_c']= null;
				$billdata['refmodeofpayment_c']= null;	
			}
		}
		else
		{
	...
	public function action_getappointmentinfo(){
		...
		$app_info['Patientaddress']=$objaddress->line1_c.', '.$objaddress->nearlandmark_c.', '.$objaddress->location_c.', '.$objaddress->city_c;	
		...
		$objAp= ORM::factory('appointment')->where('id','=',$appid)->find()->refappfromid_c;
		$objemail=ORM::factory('user')->where('id','=',$app_info['refappfromid_c'])->find()->email;
		$app_info['PatientEmail'] = $objemail;
		
		//$objA= ORM::factory('appointment')->where('id','=',$appid)->find()->refappfromid_c;
		//$objid=ORM::factory('user')->where('id','=',$app_info['refappfromid_c'])->find()->id;
		//$app_info['Patientid'] = $objid;	
		$app_info['Patientid'] = $app_info['refappfromid_c'];	
		...
		// Let the time be the 'display_c' fields content 
	...
	public function action_getpatient(){
		if($_GET){
			...
			$arr_appointments['name'] = $patients;
			$pastdata = json_encode($arr_appointments);
			die($pastdata);
	...
	/*public function action_getadmitdates(){
		if($_POST){
				
			$pat_id = $_POST['data'];
						$admitdate = "";
			//$patient= new Model_Ipdpatient;
			$patient = ORM::factory('ipdpatient')->where('refpatientuserid_c','=',$pat_id)->where('status_c','=','admitted')->find();
			//var_dump ($patient); die;
			$admitdate = $patient->admitdate_c;
			$response = json_encode($admitdate);
	...
	public function action_getincompleteappointments(){
		$doc_userid = $_GET['id'];
		
		$objAppointment = new Model_Doctorappointment;
		$apps['apps'] = $objAppointment->get_apps_desc($doc_userid,'saved');
		$response = json_encode($apps);
		header("Cache-Control: no-cache, must-revalidate");
		echo($response);
		die();
	...
	public function action_getmybillTemplate(){
		$objbill = new Model_Doctorservice;
		$mybill['bill'] = $objbill->get();
		$response = json_encode($mybill);
		header("Cache-Control: no-cache, must-revalidate");
		echo($response);
		die();
	}

	/* This function used to get bill template from appointment id 
		when staff is opening prescription */
	public function action_getdoctorbillTemplate(){
		$objbill = new Model_Doctorservice;
		$appid = $_GET['appid'];
		$mybill['bill'] = $objbill->gettemplate($appid);
		$response = json_encode($mybill);
		header("Cache-Control: no-cache, must-revalidate");
		echo($response);
		die();
