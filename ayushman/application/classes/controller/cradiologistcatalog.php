...
class Controller_Cradiologistcatalog extends Controller_Ctemplatewithmenu {
	...
	private function display($errors, $messages){
		...
		$content = View::factory('vuser/vradiologist/vradiologistcatalog');
						...
						{ //iterate through each record				
							...
							for($rowindex=2;$rowindex <= count($rows);$rowindex++){
								...
								}
								{
									...
									if(($catalogue['labtestcode'] != '')&&($catalogue['labtestname'] !='')&&($catalogue['sellingprice'] !='')&&($catalogue['discountpercent'] !='') &&($masterTests->id != null)  ){
