...
class Controller_Cdirectory extends Controller_Ctemplatewithmenu {
	...
	public function action_removestaff()
	{
		try{
			...
			$objStaff = ORM:: factory('staff')->where('id','=',$staffId)->find();
	...
	public function action_addstaff()
	{
		try{
			...
			$obj_StaffUser=ORM::factory('user')->where('email','=',$emailid)->find();
