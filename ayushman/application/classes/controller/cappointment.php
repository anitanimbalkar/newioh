	...
	public function action_finalize(){
		try{
			...
			if($object_user->has('roles', ORM::factory('role', array('name' => 'staff')))){
				...
				$staff_flag = true;
				// If Appointment booked by staff
				// Directly book appointment by standard values
				$_POST['visit_type'] = 'Follow-up';
				$_POST['incident'] = '-1';
				$_POST['payment_mode'] = '0';
				$_POST['descriptions'] = 'Appointment by Staff';
				$_POST['ayushmancharges'] = 0;
				$_POST['servicetax_ayushmancharges'] = 0;
				$_POST['totalcharges'] = 0;
				$_POST['appointmentcharges'] = 0;
				$this->action_book();
				die;
			}
