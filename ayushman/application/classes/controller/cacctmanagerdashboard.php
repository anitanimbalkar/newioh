...
class Controller_Cacctmanagerdashboard extends Controller_Ctemplatewithmenu {
	public function action_acctmanagerdashboard()
	{
	$this->display();
	...
	private function display(){
			...
			$content = View::factory('vuser/vadmin/vacctmanagerdashboard');
