...
class Rcpttransaction  {
	...
	public static function saveRcpt($fromuserid,$touserid,$amount,$caseno=null,
									$description=null,$chequeno=null,$chequedate=null,$cardtrx=null,
									$Rcptid=null,$transactionid=null)
	{
	...
	// One transactionid is generated 
		...
		{	
			...
			if ($Rcptid == null )
			{
				...
				$objRcpt ->extradesc_c = $description;
				$objRcpt ->chequedate_c = $chequedate;
				$objRcpt ->chequeno_c	= $chequeno;
				$objRcpt ->cardtrnxno_c = $cardtrx;
				$objRcpt ->caseregno_c = $caseno ;
				$objRcpt ->saveRecord();
				return $objRcpt->rcptid_c;
			}
			else
			{
				...
				$objRcpt ->amount_c   = $amount;   // Changed values should be update Amount
				$objRcpt ->extradesc_c = $description;
				$objRcpt ->chequedate_c = $chequedate;
				$objRcpt ->chequeno_c	= $chequeno;
				$objRcpt ->cardtrnxno_c = $cardtrx;
