<html lang="en">
  <head>
	   ...
	   <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<link href="/ayushman/assets/app/css/style5.css" rel="stylesheet" type="text/css"/>
		...
		<script src="/ayushman/assets/js/imageuploader/scriptUploadDoctorHeader.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="/ayushman/assets/js/imageuploader/jquery.canvasCrop.js" ></script>
	<div class="container">
		<div class="imageBox" style="height:300;width:950" >
			<div class="mask"></div>
			<div id="IDthumbBox" class="thumbBox" style="height:100px;width:650px;left:120px;top:100px" ></div>
			<div class="spinner" style="display: none">Loading...</div>
		</div>
		<div class="form-group" >
			<div class="bodytext_bold">
				Aspect Ratio	:
				Height - pixels Range(100 - 200) 
				<input type="number" id="aspectHeight" name="aspectHeigth" onchange="setaspectRatio()" max ="200" min="100" value="100">
			...
			<span id="save_thumb">
				<button id="upload"  class="btn btn-primary button"><div class="upload">Save Image</div></button>
			</span>							
			</br></br>
			<div class="col-sm-12" >
		...
		<div id="passer">
			...
			<input type="hidden" name="flag" value="UploadDoctorHeaderImage" id="flag" />
		</div>
	</div>
