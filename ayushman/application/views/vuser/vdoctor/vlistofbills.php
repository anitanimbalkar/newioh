...
<script type="text/javascript">
	...
	function typechanged(select, submit){
		...
		if($(select).find(":selected").val() == 'AllBetween'){
			...
			document.getElementById("tdforbills").style.padding="20px 0px 0px 0px";
			document.getElementById("doctorselect1").style.padding="0px 0px 14px 0px";
			document.getElementById("export").style.margin="5px 41px 6px 0px";
		
			submit = false;
		}else{
			$('#dates').hide();
			document.getElementById("tdforbills").style.padding="0px 0px 0px 0px";
			document.getElementById("export").style.margin="0px";
			document.getElementById("doctorselect1").style.padding="0px 0px 0px 0px";
...
<div style="width:828px;height:auto; overflow-x:hidden;" > 
		...
		<tr>
			<td >
				<table width="100%" height="15"  align="left" cellpadding="0" cellspacing="0" class="Heading_Bg" >
					<tr>
						<td  width="50%"  >&nbsp;<img src="/ayushman/assets/images/WhiteArrow_Icon.png" width="9" height="7"/>&nbsp;&nbsp;Bills</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table width="99.5%" border="0" cellspacing="0" style="margin-left:3px;margin-right:10px;" cellpadding="0">
		<tr>
			<td id="doctorselect1" name="doctorselect1" height="30" bgcolor="#ecf8fb" class="Bodytext_bold" style="border-top:1px solid #c6dbe4;border-bottom:1px solid #c6dbe4; display:<?php if($pos == 0){echo 'block';}else{echo 'none';} ?>"><div  style="vertical-align:top; width:210px;float:left;padding-top:3px;">&nbsp;&nbsp;Doctor Name : 
					<select style="width:100px"  name="selectedDoctor" onchange="$('#searchform').submit();" class="textarea" id="doctorlistbox" > 
			...
			<td height="30" id="tdforbills" bgcolor="#ecf8fb" class="Bodytext_bold" style="border-top:1px solid #c6dbe4;border-bottom:1px solid #c6dbe4; "><div style="vertical-align:middle; width:240px;float:left;padding-top:3px;">Search Options 
					<select name="type" class="textarea" onchange="typechanged(this)" id="type" style="width:150px"> 
						<?PHP 
								$type = array();
								$type['New'] = 'Only New Bills';
								$type['All'] = 'All (exported and new)';
								$type['AllBetween'] = 'All Bills (exported and new) Between';
			...
			<div style="width:100px;float:right;display:none;">
			...
			<input type="hidden" id="exportto" name="exportto" value="" />
								...
								<?php
									...
									$consumers->post('sortname','TransactionId');
									$consumers->post('sortorder','desc');
									$consumers->post('tablename','exportbill');
									$consumers->post('columnnames','AccountCode,PaidBy,TransactionId,Reason,Amount,cashpaymentflag,Date');
									$consumers->post('whereclause',$whereclause);//used for jqgrid
									$columninfosearch = '[
											{"name":"Account Code","width":"15","index":"AccountCode","hidden":true},
											{"name":"Name","width":"15","index":"PaidBy","hidden":false},
											{"name":"Bill Id","width":"13","index":"TransactionId","hidden":false},
											{"name":"Reason","width":"30","index":"Reason","hidden":false},
											{"name":"Amount","width":"10","align":"right","index":"Amount","hidden":false},
											{"name":"Payment Mode","width":"20","formatter":checkMode,"align":"center","index":"Amount","hidden":false},
