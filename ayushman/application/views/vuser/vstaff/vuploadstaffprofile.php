<html lang="en">
  <head>
	   ...
	   <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<script src="/ayushman/assets/js/imageuploader/scriptuploadstaffprofile.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="/ayushman/assets/js/imageuploader/jquery.canvasCrop.js" ></script>
	<div class="container">
		...
		<div id="passer">
			...
			<input type="hidden" name="flag" value="uploadstaffprofileimage" id="flag" />
		</div>
