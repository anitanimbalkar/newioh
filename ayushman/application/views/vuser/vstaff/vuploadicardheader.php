<html lang="en">
  <head>
	   ...
	   <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<link href="/ayushman/assets/app/css/style7.css" rel="stylesheet" type="text/css"/>
		...
		<script src="/ayushman/assets/js/imageuploader/scriptUploadIcardHeader.js" type="text/javascript"></script>
  ...
  <body width="600px;">
	...
	<div class="container">
		...
		<div id="passer">
			...
			<input type="hidden" name="flag" value="UploadIcardHeaderImage" id="flag" />
		</div>
