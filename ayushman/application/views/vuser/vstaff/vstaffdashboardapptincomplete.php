 ...
 <script type="text/javascript">
	...
	{
		var pat_id = $(rowObject).children()[11].firstChild.data;
		var appointment_id = $(rowObject).children()[10].firstChild.data;
		var dr_id = $(rowObject).children()[0].firstChild.data;
		return '<a style="color:blue;" href="#" onclick="gotoprescription('+appointment_id+','+pat_id+','+dr_id+')" >Consultation</a>';
	}
	function gotoprescription(appointment_id,pat_id,dr_id)
	{
		parent.location.href ='/ayushman/cpatientprescriptiondisplay/displayprescription?#/doctordashboardconsultation?appid='+appointment_id+'&patient_id='+pat_id+'&role=staff&drid='+dr_id+'&quick=1';
	}
</script>
		...
		<tr  class="bodytext_normal" align="right"  width="100%">    
			<td colspan="2" valign="top">
				<?php
					...
					$searchpathojqgridrequest->post('tablename','doctorstaffappointmentincompleted');
					/*$searchpathojqgridrequest->post('columnnames','doctorUserid,dateandtime_dateformate,incidentid,Doctorsname,Patientname,DateAndTime,type,city,chargestatus,staffid,appointment_id,refappfromid_c,chargestatus');*/
					$searchpathojqgridrequest->post('columnnames','doctorUserid,dateandtime_dateformate,doctorUserid,Doctorsname,Patientname,DateAndTime,type,city,doctorUserid,staffid,appointment_id,refappfromid_c,appointment_id');
					$x="[staffid,=,".$staffid."]";
					$v=$x.$whereclause;
					...
					$columninfosearch = '[
								...
								{"name":"Action","index":"Action","width":80,"align":"center","formatter":actionFormatter,"align":"left"},
