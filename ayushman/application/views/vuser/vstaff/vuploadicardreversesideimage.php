<html lang="en">
  <head>
    ...
    <link href="/ayushman/assets/app/css/style6.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="/ayushman/assets/js/imageuploader/scripticardreverseside.js" type="text/javascript"></script>    
  ...
  <div class="imageBox" >
	...
	<button id="rotateLeft"  class="btn btn-primary button">rotateLeft</button>&nbsp;
	<button id="rotateRight"  class="btn btn-primary button">rotateRight</button>&nbsp;
	...
	<img src="" id="thumbnail"  />
			<div id="passer">
						...
						<input type="hidden" name="flag" value="UploadIcardReverseSideImage" id="flag" />
  </div>
  </div>
