...
function openHeaderUploder(){
	openDialog("/ayushman/cimagedisplay/uploadIcardHeader?userid="+<?php echo $id; ?>,800,800,this);
}

function openFooterUploder(){
	openDialog("/ayushman/cimagedisplay/uploadIcardFooter?userid="+<?php echo $id; ?>,800,800,this);
}
function openUploder(){
	openDialog("/ayushman/cimagedisplay/UploadIcardReverseSide?userid="+<?php echo $id; ?>,800,800,this);
}
  ...
  function openPreview()
		{
			...
			var url = "/ayushman/upload/previewicardtemplate?id="+<?php echo $id; ?>;
			$.ajax({
			  type: "GET",
			  url: url,
			  success: function(data) {
				  ...
				  //$('#preview').show();
			      //console.log(data);
				  openDialog('/ayushman/home/previews/previewicard.php', 700, 500);  
                  //alert('hi');				  
			  }
...
<div class="panel" style="max-width:100%;height:auto;overflow:hidden;">
	...
	<div style="width:100%; margin:15px;">
		<div style="background-color:#ecf8fb;width:96%;">
			...
			Upload Header,Footer and Reverse side image for your <em>IndiaOnlineHealth I-Card</em></div>
		</div>
		<div  >
			<div >
			<img style="width:80%;height:45%" src="<?php if($objstaff->icardheader_c == ""){echo 'I-Card Header Not Uploaded';}else{echo "/". $objstaff->icardheader_c;}?>" alt="" /><br>
		...
		<div class="staff-left">
			...
			<a href="javascript:void(0);" ><img style="width:80%;height:45%" src="<?php if($objstaff->icardfooter_c == ""){echo 'I-Card Header Not Uploaded';}else{echo "/". $objstaff->icardfooter_c;}?>" alt="" /><br>
			...
			<div class="staff-left">
			<div class="profile-image">
			<!--<a href="javascript:void(0);" ><img style="width:25%; height:20%" src="" alt="" /><br>-->
				<input type="button" value="Upload Reverse Side Image" class="regnbutton" style="width:30%" onclick="openUploder();" /><br>
			</a>
			</div>
		   </div>
