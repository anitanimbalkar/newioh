<head>
		...
		<link rel="stylesheet" href="/ayushman/assets/app/css/bootstrap.min.css" />
			...
			<script src="/ayushman/assets/app/js/controllers/uploadpathreportctrl.js"></script>
...
<!--<input id="testid" name="testid" type="hidden" class="formtextarea" value="--><!--?php echo $testid; ?>"/>-->
	...
	<div id="ng-app" style="height:400px;"ng-app="app" ng-controller="uploadpathreportctrl">
	<div class="col-md-3">
		<div class="textcolor">
		</br>
