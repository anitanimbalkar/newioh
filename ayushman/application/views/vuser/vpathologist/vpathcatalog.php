...
function opentestpopup(date)
	...
	function onclickaddtest()
	{
		...
		{
			$.ajax({
				url: "/ayushman/cpathologistneworder/ordertest?test="+JSON.stringify(selection)+"&patid="+patid+"&reqdate="+reqdate+"&rate="+JSON.stringify(selectionRate)+"&atcenterflag="+radiobtn+"&totalOrdvalue="+totalOrdvalue,
...
<div style="width:835px;height:560px;" > 
    <table border="0" cellpadding="0" cellspacing="0" valign="top">
		...
		<input id="testArrayIds" name="testArrayIds" type = "hidden"/>
		<input id="testArrayRates" name="testArrayRates" type = "hidden"/>
		<input id="testArrayDiscRates" name="testArrayDiscRates" type = "hidden"/>
		<input id="testArrayNames" name="testArrayNames" type = "hidden"/>
		</br>
		<tr>
				...
				<td height="auto" colspan="3" align="left" valign="middle" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<!-- <tr>
							...
							<td id="tdtotalamount" class="bodytext_normal" style="width:66px;padding-top:10px;" valign="top"><lable id="labtesttotalfees" class='totalfee'>0</lable></td>
						</tr> -->
					</table>
				</td>
			</tr>
			...
			<tr>
				<td width="25%" align="left" valign="top" style="padding-top:20px;padding-bottom:10px;padding-left:20px;">
 				...
 				<td width="15%" align="left" valign="top" style="padding-top:20px;padding-bottom:10px;padding-right:2px;">
					<input id='testdate' name='testdate' readonly= "readonly" style="height:25px;" onclick='setcalender(this.value);' value='<?php echo date('d M Y');?>'>
				</td>
