<html lang="en">
  <head>
    ...
    <script src="/ayushman/assets/js/imageuploader/scriptuploadfooter.js" type="text/javascript"></script>    
  ...
  <div class="imageBox" >
	...
	<img src="" id="thumbnail"  />
			<div id="passer">
						...
						<input type="hidden" name="flag" value="uploadfooterimage" id="flag" />
  </div>
  </div>
