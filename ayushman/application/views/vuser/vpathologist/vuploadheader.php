<html lang="en">
  <head>
	   ...
	   <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<script src="/ayushman/assets/js/imageuploader/scriptuploadheader.js" type="text/javascript"></script>
  ...
  <body width="600px;">
	...
	<div class="container">
		...
		<div id="passer">
			...
			<input type="hidden" name="flag" value="uploadheaderimage" id="flag" />
		</div>
