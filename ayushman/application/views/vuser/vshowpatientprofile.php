				...
				<td width="100%" align="left">
					<table valign="top">
						<tr class="bodytext" >                
						  	...
						  	<td align="left" style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"> <?php echo $patient->identificationnumber_c;  ?> 
						  	</td>                
						</tr>
						<tr  class="bodytext">                
						  	<td width="130px" >Name </td>
						  	<td align="left"style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $patient->Firstname_c.' '.$patient->middlename_c.' '.$patient->lastname_c;  ?>
						  	</td> 
						</tr>
						<tr  class="bodytext">                 
						  	<td width="130px" >Gender</td>
						  	<td align="left"style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"> <?= trim($patient->gender_c);?>
						  	</td>
						</tr>
						<tr  class="bodytext">                 
						  	<td width="130px">Date of Birth</td>
						   	<td align="left" style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php if($patient->DOB_c) echo date('d-M-Y',strtotime($patient->DOB_c)) ;  ?> 
						  	</td>				  
						</tr>
						<tr class="bodytext">
							<td width="130px">Blood Group</td>
							<td align="left" style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?= trim($patient->bloodgroup_c);  ?>
							</td>
						</tr>
						<tr  class="bodytext">                 
						  	<td width="130px">Marital status</td>
						  	<td align="left"style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?= trim($patient->maritalstatus_c);  ?>
						  	</td>
						</tr>
						<tr  class="bodytext">                 
						 	<td width="130px">Preferred Language</td> 
						  	<td align="left" style="background: transparent;border:none;font-weight:bold;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?= trim($patient->languages_c); ?>
						  	</td>  
						</tr>
					</table>
				</td>
								...
								<td style="width:99%;" >
									<table  cellpadding="0" cellspacing="0" style="width:100%;"align="left">		
										...
										<tr class="bodytext" align="left">
											...
											<td width="35%" style="background: transparent;border:none;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $patient->phonenohome_c;  ?></td>   
										</tr>
										<tr class="bodytext" align="left">
											<td >Mobile No1</td>
											<td style="background: transparent;border:none;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $patient->mobileno1_c;  ?></td>
											<td width="15%"> Mobile No2 </td>
											<td width="35%"style="background: transparent;border:none;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $patient->mobileno2_c;  ?></td>                 
										</tr>				
										<tr class="bodytext" align="left">
											<td >Line 1 </td>
										...
										<tr class="bodytext" align="left" style="padding-top:10px;">
											...
											<tr class="bodytext" align="left">
											  ...
											  <td style="background: transparent;border:none;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $objaddwork->country_c;  ?>
											   ...
											   <td >Phone Work </td><td style="background: transparent;border:none;width:300px; line-height:9pt; height:15px;" class="bodytext_normal"><?php echo $patient->phonenowork_c; ?>
											  </td>   		               
											</tr>
