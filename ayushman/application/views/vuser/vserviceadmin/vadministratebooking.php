		...
		<?php 
			$result = $packageservices;
			   for($i=0;$i<count($result);$i++){
					...
					echo "addTab('".$service->name_c."','/ayushman/cservicecomponents/foradmin?serviceid=".$service->id."&packageid=".$package['id']."&userid=".$userid."&bookingid=".$packagebooking['id']."');";
			  }
		?>
	});
...
<div style="width:810px;height:auto; vertical-align:middle;padding:7px;margin:3px; overflow-x:hidden;" class="Heading_Bg"> 
	&nbsp;<img src="/ayushman/assets/images/WhiteArrow_Icon.png" width="9" height="7"/>&nbsp;&nbsp;Administrate Booking
</div>
<div style="width:810px;height:auto; vertical-align:middle;padding:6px;margin:3px; overflow-x:hidden;border:1px solid #c6dbe4;"> 
	<div style="height:auto;width:798px;"  >	
		<div style="height:auto;width:inherit;float:left;padding:7px;">
		...
		<div style="height:auto;width:inherit;float:left;padding-left:7px;padding-right:7px;">
			<hr/>
		</div>
	...
	<div style="height:auto;width:798px;float:right;" >				  
		<table width="100%">
			<tr>
				<td width="10%" align="left" style="padding:5px;" class="bodytext_normal" style="align:right;">Camp Name :</td>
				<td width="35%" align="left" style="padding:5px;" class="bodytext_normal"><span class="bodytext_bold"><?php echo $packagebooking['name_c']; ?></span></td>
				<td width="10%" align="left" style="padding:5px;vertical-align:top;" class="bodytext_normal" style="align:right;">Date :</td>
				<td width="35%" align="left" style="padding:5px;" class="bodytext_normal"><span class="bodytext_bold"><?php echo $packagebooking['date_c']; ?></span></td>
			</tr>
		</table>
	</div>
</div>
<div id="tt" class="easyui-tabs" style="width:810px;height:300px;vertical-align:middle;padding:6px;margin:3px; overflow-x:hidden;border:1px solid #c6dbe4;">
</div>
