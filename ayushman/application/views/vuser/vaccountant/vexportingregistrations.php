		...
		<tr>
			<td >
				<table width="100%" height="15"  align="left" cellpadding="0" cellspacing="0" class="Heading_Bg" >
					<tr>
						<td  width="50%"  >&nbsp;<img src="/ayushman/assets/images/WhiteArrow_Icon.png" width="9" height="7"/>&nbsp;&nbsp;New Registrations</td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td height="30" bgcolor="#ecf8fb" class="Bodytext_bold" style="border-top:1px solid #c6dbe4;border-bottom:1px solid #c6dbe4; padding:10px;"><div style="vertical-align:middle; width:240px;float:left;padding-top:3px;">Search Options 
					<select name="type" class="textarea" onchange="typechanged(this)" id="type" style="width:150px"> 
						<?PHP 
								$type = array();
								$type['New'] = 'Only New Registrations';
			...
			<input type="hidden" id="exportto" name="exportto" value="" />
								...
								<?php
									...
									$consumers->post('name','newregistrations');
									$consumers->post('height','420');
									$consumers->post('width','820');
									$consumers->post('sortname','Name');
									$consumers->post('sortorder','desc');
									$consumers->post('tablename','newregistration');
									$consumers->post('columnnames','iohid,Name,accountcode,EmailID,MobileNumber,Telephone,RegistrationDate,Address,PAN,ServiceTaxRegistrationNumber,VATorTIN');
									$consumers->post('whereclause',$whereclause);//used for jqgrid
									$columninfosearch = '[
											{"name":"IOH Id","width":"10","index":"iohid","hidden":false},
											{"name":"Name","width":"20","index":"Name","hidden":false},
											{"name":"Account Code","width":"20","index":"accountcode","hidden":false},
											{"name":"Email ID","width":"30","index":"EmailID","hidden":false},
											{"name":"Mobile Number","width":"20","index":"MobileNumber","hidden":false},
											{"name":"Telephone","width":"20","index":"Telephone","hidden":false},
											{"name":"Reg. Date","width":"20","index":"RegistrationDate","hidden":false}
										]';
