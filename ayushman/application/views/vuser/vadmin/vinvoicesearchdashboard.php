...
function newpagefunction(cellvalue, options, rowObject){
	...
	return ' <a style="color:blue;" href="#" onclick="createnewinvoice('+spid+')" >'+name+'</a>';
}	
	
function createnewinvoice(spid){	
		var invtype = 'IT';
	window.location='/ayushman/cinvoice/viewkart?spid='+spid+"&invtype="+invtype;
}
function backpage(){		
	window.location='/ayushman/cinvoicesales/view';
}
</script>
<style>
hr {
			...
			<tr>
				<td >
					<table width="100%" height="15"  align="left" cellpadding="0" cellspacing="0" class="Heading_Bg" >
						<tr>
							<td  width="50%"  >&nbsp;<img src="/ayushman/assets/images/WhiteArrow_Icon.png" width="9" height="7"/>&nbsp;&nbsp; Invoice</td>
							<td align="right"><a href="#" onclick="backpage();"><img src="/ayushman/assets/app/img/goback2.png" style="height: 25px; width: 80px;"></a></td>
						</tr>
					</table>
				</td>
			</tr>
	...
	<form id="serviceproviderform" method="POST" enctype="multipart/form-data" action="search">			
		...
		<table >	
				<tr class="Bodytext_bold" >
					<td height="20" >Search Options: </td>
					<td> &nbsp;
