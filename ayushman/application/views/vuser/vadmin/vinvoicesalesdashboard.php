...
<input type="hidden" id="statdefine" value="<?php echo $searchstat; ?>"/>	              
	...
	<table width="100%" >	
		<tr> 
			...
			<td align="right">
				<input id="createinvbtn" style="width:120px" type="button" class="button" onclick="createinvoice();" value="Create new Invoice"/>
			</td>
		</tr>		
	</table>
	<form id="serviceproviderform" method="POST" enctype="multipart/form-data" action="">			
			<table width="100%">	
				<tr class="Bodytext_bold" >
						...
						<td>
							<span class="bodytext_normal">Invoice no</span> &nbsp; <input name="invno" title="Enter Invoice number" id="invno" placeholder="Enter invoice number" type="text"  value="<?php if ($previousvalues != null)if (isset($previousvalues['invno'])) echo $previousvalues['invno'];?>" class="textarea" size="17"/>
						</td>
					
				</tr>
				<tr>
				<td></td>
				<td><span class="bodytext_normal">From</span> &nbsp; <input name="from" id="from" title="Enter From date " placeholder="From date" type="text"  value="<?php if ($previousvalues != null)if (isset($previousvalues['from'])) echo $previousvalues['from'];?>" class="textarea" size="17"/></td>
					<td><span class="bodytext_normal">To &nbsp; <input name="to" id="to" type="text" title="Enter To date" placeholder="To date"  value="<?php if ($previousvalues != null)if (isset($previousvalues['to']))echo $previousvalues['to'];?>" class="textarea" size="17"/></td>
						...
						<div id="admingrid" align=center >					
							<?php				
								...
								$columninfo ='[{"name":"Invoice no", "index":"invoiceid","width":80, "hidden":false,"align":"left"},
												...
												{"name":"Generated by", "index":"csrname","width":80,"hidden":false,"align":"left","hidden":true},
