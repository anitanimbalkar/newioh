	...
	<table width="100%"  height="35px" border="0" cellpadding="0" cellspacing="0" style="align:left;" >
		<tr>
			<td style="width:99%;" colspan="4" class="Heading_Bg">
				Doctorwise Prescriptions
			</td>			
		</tr>
		<tr>
			<td align="left" valign="center" width="30%" class="bodytext_normal" style="padding-top: 6px">Generated During: 
		...
		<tr  class="bodytext_normal" align="right"  width="100%">    
			<td colspan="4" valign="top">
				<?php
					...
					$consumers->post('tablename', 'doctorwiseprescription');
					$consumers->post('columnnames', 'appid,doctorname,prescriptiondate,userid,patientname,nooftests,chemorderid,orderid');
					$consumers->post('whereclause', $whereclause); //used for jqgrid

					$columninfosearch = '[
													{"name":"Id","index":"appid","hidden":true},
													{"name":"Doctor Name", "index":"doctorname", "hidden":false,"width":15},
													{"name":"Prescrition Date", "index":"prescriptiondate", "hidden":false,"width":15},
													{"name":"IOH No","index":"userid","hidden":false,"width":7},
													{"name":"Patient Name","index":"patientname","hidden":false,"width":15},
													{"name":"No. Of tests", "index":"nooftests", "hidden":false,"width":10},
													{"name":"Chem Order Id", "index":"chemorderid", "hidden":false,"width":10},
													{"name":"Lab Order Id","index":"orderid","hidden":false,"width":13}
												]';
