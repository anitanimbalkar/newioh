...
if ($previousvalues != null)
    echo ($previousvalues['role'] == 'doctor') ? 'selected' : '';
?>   >Doctor</option>
...
if ($previousvalues != null)
    echo ($previousvalues['role'] == 'chemist') ? 'selected' : '';
?>  >Chemist</option>
						<option value='Pathologist' <?php
if ($previousvalues != null)
    echo ($previousvalues['role'] == 'Pathologist') ? 'selected' : '';
?>  >Pathologist</option>
						<option value='staff' <?php
if ($previousvalues != null)
    echo ($previousvalues['role'] == 'staff') ? 'selected' : '';
?>  >Staff</option>
						</select>
			</td>
