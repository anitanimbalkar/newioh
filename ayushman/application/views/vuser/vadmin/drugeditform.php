...
<div  id="diveditdrug" class="content_bg" style=" width:100%; height:93%;overflow:auto;" align="center" > 
	<table id="editdrugtable" class="body_bg" width="100%" border="0" cellspacing="0" cellpadding="0" style="overflow-y:hidden;border:0px;overflow-x: hidden;padding-left:10px;padding-right:10px;padding-top:10px">
	 <form id="bill" action ="/ayushman/cmasterdatavalidation/savedrugdetails" method="post">
		<tr>
		...
		<tr>
			...
			<td align="left" style="padding-left:10px;padding-top:6px" class="bodytext_bold">strength:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="strength" placeholder="Drug Strength" title="Strength displayed along with medicine while prescribing" style=" width:57.5%;border:none; border-bottom:1px solid;"value="<?php echo trim($objdrug->drugStrength_c); ?>"/></td>
		</tr>
		<tr>
			<td align="left" style="padding-left:10px;padding-top:6px" class="bodytext_bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td align="left" style="padding-left:10px;padding-top:6px" class="bodytext_bold">strength used for calc:<input name="strengthinmg" type="number" placeholder="Drug Strength /ml /TAB" title="Strength used for calculating pediatric dosage" style=" width:49%;border:none; border-bottom:1px solid;"value="<?php echo trim($objdrug->drugStrengthinmg_c); ?>"/></td>
		</tr>
		<tr>
		...
		<tr>
				<td colspan="2" style="padding-left:10px;padding-top:10px" class="bodytext_normal">
					<input type="submit" class="button" height="22" style="width: 80px; height: 25px; " value="Save" onclick="$('#bill').submit();"/>
				</td>
		</tr>
		</form>
