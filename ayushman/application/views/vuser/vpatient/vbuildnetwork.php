...
<body>
	...
	<div id="ng-app" ng-app="app" style="position:relative;max-width:1024px;min-height:550px;font-size:12px !important; width:100%;margin:0px auto 0px auto;" ng-controller="networkCtrl">
		<h5 style=" background: #5cb1b6 !important;border-radius: 0;color:#fff; padding: 10px 5px 10px 15px;margin-top: 0;"><span>Preferred Chemist and Diagnostic Center</span><span style="float:right;right:0">Name Of The Patient : <?php echo $name.' '.$mobilenumber; ?></span></h5>
		<div ng-include src="'/ayushman/assets/app/partials/patientnetwork.html'"></div>
	</div>
</body>