				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="25" colspan="4" align="left" class="bodytext_normal" valign="middle" bgcolor="#ecf8fb" style="border-top:1px solid #a8c8d9;border-bottom:1px solid #a8c8d9;padding-left:10px;">
							<input type="hidden" id="isemailvalid" name="isemailvalid" value="false"/> 
			...
			<table cellspacing="6">
				...
				<tr>
					<td width="440px" colspan="2" class="bodytext_normal">
						...
						<input type="radio" value="both" id="both" onclick="email = new LiveValidation('emailid'); email.enable(); email.add( Validate.Presence );email.add( Validate.Email );$('#both').is(':checked') ? $('#email').show() : $('#email').hide();$('#isemailvalid').val(false);"  name="operateaccount" >Both My relative and I will operate this account</input>
					</td>
				</tr>
				<tr id="email" style="display:none;">
					...
					<td width="370px">
						:&nbsp;&nbsp;<input type="text" class="textarea" style="width:200px;" onblur="checkEmail(this)" maxlength="45"  value="<?php if($previousvalues != null)if(isset($previousvalues['emailid']))echo $previousvalues['emailid']; ?>" id="emailid" name="emailid" /> <div id="emailerror" style="display:none;" class="bodytext_error">&nbsp;&nbsp;&nbsp;Email must be unique. Please write other email ID.</div>
						<script>
