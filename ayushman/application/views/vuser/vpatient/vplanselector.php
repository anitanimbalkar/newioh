...
<body bgcolor="#FFFFFF" leftmargin="0" style="height:auto" topmargin="0" marginwidth="0" marginheight="0">
<!-- removed class="plan-details-modal" -->
	...
	<table style="width:100%; height:100%;" border="0" valign="top" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" valign="top" class="body_bg" style="valign:top;">
                ...
                <!-- Heading -  end -->
				<div class="table_roundBorder plan-instructions">
					<div id="help-main" style="margin-left:5px;">
						<p class="bodytext_bold"style="font-size:12px;color: #1c75bc;">Please choose any one of the plans listed below.</p>
					</div>
					<div id="help-main" style="margin-left:5px;">
						<p class="bodytext_bold"style="font-size:12px;color: #1c75bc;">(Registration Charges are applied only once and Subscription Charges will be charged according to plan chosen)</p>
					</div>
				...
				<table width="100%" valign="top" border="0" cellpadding="0" cellspacing="0" style="padding-top:5px;">
					...
					<tr >
						<td colspan="6" rowspan="7" align="left" valign="top" class="content_bg" style="padding-top:5px;">
                            ...
                            $plans = array();
                            echo '<div style="white-space: wrap;"><ul id="navlist" class="apply-plan-list">';
                            foreach($objPlans as $plan)
							{
							// Condition to show Ayushcare plan only to Ayushcare user only
							// Plan id 115 should be shown only for ayushcare otherwise blocked

							if(($showayushplan == 1) OR ($plan->id !=115 AND ($showayushplan==0)))
							{
				...
				<div class="col-xs-12">
					<a class="pull-left button plan-back-btn" onclick="window.location = '/ayushman/cplanmanager/showselectedplan'" href="javascript://">
						Back
					</a>
				</div>
			</td>
...
<div id="plandetails" width="100%" height="450px" style="-moz-border-radius: 2px;display:none;-webkit-border-radius:2px; -khtml-border-radius: 2px; border-radius:2px;overflow: auto;">
	<style type="text/css">
		table.imagetable {
	...
	<script type="text/JavaScript">
		...
		{
			showMessage('100%','215','Select Plan',data['data'],'confirmation','planselectionconfirmation');
                    }
                },
	...
	<form id="planform" method="post" enctype="multipart/form-data" >
		...
		<table width="98%" border="0" cellspacing="0" cellpadding="0"  class="imagetable" style="margin: 0 auto;">
			<tr>
			...
			<tr>
				<td align="center" ><span class="bodytext_bold">Consultation</span></td>
				<td align="center"><span class="bodytext_bold">Online (Rs.)</span></td>
				<td align="center" valign="middle" ><span class="bodytext_bold">Phone (Rs.)</span></td>
				<td align="center"><span class="bodytext_bold">In Clinic (Rs.)</span></td>
			...
			<tr>
				...
				<td width="14%" align="center" valign="middle" class="bodytext_normal"><label align="left" id="onlinecharges"></label></td>
				<td width="14%" align="center" valign="middle" class="bodytext_normal"><span class="bodytext_normal"><label align="left" id="phonecharges"></label></span></td>
				<td width="17%" align="center" valign="middle" class="bodytext_normal"><span class="bodytext_normal"><label align="left" id="cliniccharges"></label></span></td>
			...
			<tr>
				...
				<td align="center" valign="middle" class="bodytext_normal"><span class="bodytext_normal"><label align="left" id="onlinecharges"></label></span></td>
				<td align="center" valign="middle" class="bodytext_normal"><span class="bodytext_normal"><label align="left" id="phonecharges"></label></span></td>
		...
		<div style="padding-top:10px;padding-bottom:10px;" >
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td align="center" width="15%" height="50%" valign="middle" onclick="selectplan();" class="button select-btn">Apply</td>
					<td align="center" width="5%" height="50%" valign="middle" >&nbsp;</td>
