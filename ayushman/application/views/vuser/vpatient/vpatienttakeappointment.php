...
<script type="text/javascript">
		...
		else
		{
			if(selecteddates.length >= 1)
			{
				...
				else
				{
					...
					$.ajax({
						  url: '/ayushman/cpatientfavoritedoctor/saveappointment?id=<?php echo $doctorid; ?>&type='+document.getElementById('slottype').value+'&mode='+getselectedmode()+'&dates='+JSON.stringify(selecteddates)+'&incidenceid='+incidenceid+'&incidencename='+incidencename+'&paymentmode='+value+"&noofslots="+$("#noofslots").val()+"&longvisit="+longvisit+"&shortvisitduration="+$("#shortvisitduration").val()+"&rescheduledappid=<?= $rescheduledappid;?>&blockslotduration="+$("#blockslotduration").val()+"&appstrategytype="+$("#appstrategytype").val()+"&currentlocation="+currentlocation ,
	...
	function getselectedmode()
	{
		...
		var selection =$("#modetype").val();
		
		var selectedmode = "";
		for (i=0; i<modes.length; i++)
		{
			if (modes[i].toLowerCase() == $("#modetype").val().toLowerCase())
			{ 
	...
	$(document).ready(function(){		
		...
		$('#paymentmode').dialog({
				...
				buttons: {
					"Ok": function () {
						saveAppointment($('input[name="payment"]:checked').val());						
						$(this).dialog('close');
					},
  ...
  return (input.toString()).replace(
					...
					else if (earliestdata == 'notfound')
					{
						...
						$.ajax({
							  ...
							  success: function( data ) {
									...
									$("#lblapp").text(trim(date+ " ,"+earliestdata.time ));
	...
	function showappdetails()
	{
		...
		$('#doccalforpat').datepicker("setDate", selecteddate);
		dateinstance.selectedYear 	= 1900+selecteddate.getYear();
		dateinstance.selectedMonth	= selecteddate.getMonth();
		dateinstance.selectedDay	= selecteddate.getDate();
		date = (1900+ selecteddate.getYear())+'-'+(selecteddate.getMonth()+1)+'-'+selecteddate.getDate()+', '+selectedtimes;
		$("#lblvisitype").text($('#ddvisittype').val());
		$("#lblmode").text($("#modetype").val());
		$("#lblplace").text($("#ddplace").val() );
...
<div id="wrapper" style="width:828px;border:none; height:620px; padding-left:0px;">
                ...
                <tr>
                  <td class="gradient_Bg" style="padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px;">
                    ...
                    <tr>
                      ...
                      <td width="108"><select name="select" id="modetype" onchange="hideappdetail()" style="height:20px; width:auto;">
                  ...
                  <td colspan="6" align="left" valign="top" class="style17" style="padding-left:10px; padding-top:10px;"><table width="790" border="0" cellpadding="0" cellspacing="0" class="table_Border">
                    <tr>
                      ...
                      <td width="297" rowspan="4" align="left" valign="top" style="padding-top:8px; padding-left:5px; padding-bottom:8px; padding-right:5px;">
						...
						<tr>
                          <td height="22" align="left" valign="middle" bgcolor="#FFFFFF" class="bodytext_styleBlue" style="padding-left:10px;">Current Bal.</td>
                          <td height="22" align="left" valign="top" bgcolor="#FFFFFF" class="bodytext_styleBlue">:</td>
                          <td height="22" align="left" valign="middle" bgcolor="#FFFFFF" class="text_style">Rs. <label id="lblbal" ></label></td>
                        </tr>
                        <tr>
                    ...
                    <tr>
					  ...
					  <table width="320" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="160" align="center" valign="middle" class="button" onClick="onrechargeclick();" ><strong>Recharge Account</strong> </td>
                          <td width="10">&nbsp;</td>
                          <td width="150" align="center" valign="middle" class="button"  onClick="checkmode();"><strong>Take Appointment</strong></td>
                        </tr>
                      </table></td>
                      </tr>
 ...
 <div id='paymentmode'>
  <p>You can make payment online or can be paid at the time of consultation. Select following appropriate option and go ahead.<br/><form><input type="radio" id="onlinepayment" name="payment" value="0" >Pay online.</input><br /><input type="radio"  name="payment" id="inclinicpayment" value="1" checked >Pay at the time of appointment.</input></form></p>
  <p>IOH Service charges as Rs. 5/- will be deducted online even if you select 'Pay at the time of appointment' option. Your account must contain more or equal to Rs. 5/- </p>
</div>
