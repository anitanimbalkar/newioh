								...
								<div class="panel-body">
									<table class="table">
										<tr id="upappoint" name="upappoint" onmouseover="showstep(4)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="getcontent('/ayushman/cpatientdashboard/view');uncheckbox();" href="javascript:void(0);">Upcoming Appointment</a>
											</td>
										</tr>
								...
								<div class="panel-body">
									<table class="table">
										<tr id="editemr" name="editemr" onmouseover="showstep(0)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="window.location = '/ayushman/cpatienthistorydisplay/view?#/patientemr/<?php echo Auth::instance()->get_user()->id; ?>;uncheckbox();'" href="javascript:void(0);">View / Edit EMR</a>
											</td>
										</tr>
										<tr id="editemr" name="editemr" onmouseover="showstep(0)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="window.location = '/ayushman/cpatienthistorydisplay/view?#/patienttracker/<?php echo Auth::instance()->get_user()->id; ?>;uncheckbox();'" href="javascript:void(0);">Universal Tracker </a>
											</td>
										</tr>
								...
								<div class="panel-body">
									<table class="table">
										<tr id="docnet" name="docnet" onmouseover="showstep(8)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="getcontent('/ayushman/cdoctordirectory/view');uncheckbox();" href="javascript:void(0);">Doctor</a>
											</td>
										</tr>
										<tr id="Diagnosticnet" name="Diagnosticnet" onmouseover="showstep(9)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="getcontent('/ayushman/cpathologistdirectory/view');uncheckbox();" href="javascript:void(0);">Diagnostic Center</a>
											</td>
										</tr>
										<tr id="Chemistnet" name="Chemistnet" onmouseover="showstep(10)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="getcontent('/ayushman/cchemistdirectory/view');uncheckbox();" href="javascript:void(0);">Chemist </a>
											</td>
										</tr>
										<tr id="Relatives" name="Relatives" onmouseover="showstep(11)" onmouseout="hidestep()">
											<td>
												<a class="menu-links" onclick="getcontent('/ayushman/crelative/view');uncheckbox();" href="javascript:void(0);">Relatives </a>
											</td>
										</tr>
									</table>
								</div>
