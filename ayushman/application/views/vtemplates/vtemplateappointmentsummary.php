...
<body style="width:1024px">
	<div style="height:auto;width:100%;">
		...
		<div id="name" style="height:auto;width:100%;">
			...
			<label id='lblqualification' style="font:bold;font-size:14pt;font-family:arial;">MD (Med)</label>
					...
					<div style="height:5px;width:100%;margin-top:5px;layout:horizontal;float:right;"> 
						<table style="height:auto;width:100%;padding-top:5px;">  
							<tr>
								...
								<td style="height:auto;width:15%;vertical-align:top">
				...
				<td style="width:auto;">
					<div style="height:60px;width:100%;margin-top:2px;layout:horizontal;float:left;vertical-align:top;"> 
						<div style="height:100%;width:100%;vertical-align:top; layout:horizontal;float:left;padding-top:17px">
							...
							<br/>
							<label style="margin-left:1%;font:bold;font-size:14pt;font-family:arial;font-weight:bold;">IOH&nbsp;#&nbsp;</label>
		...
		<div style="height:auto;width:100%;margin-top:5px;layout:vertical;float:left;">
			<table style="width:100%;height:auto;">
				<tr style="width:100%;height:10px;">
					<td style="width:100%;height:10px;">
						<label style="margin-left:1%;font:bold;font-size:14pt;font-family:arial;font-weight:bold;">Summary : </label>
					</td>
				</tr>
				<tr>
					<td>
						<label id='lblpatientsummary' style=" margin-left:1%;font-size:13pt;font-family:arial;">-</label>
						<hr style="margin-left:1%;"/>
					</td>
				</tr>
			</table>
	...
	<div style="height:auto;width:100%;">
		<div style="height:auto;width:100%;align:center" align="center">
			<label style="margin-left:1%;font:bold;font-size:14pt;font-family:arial;font-weight:bold;">Prescription</label>
		</div>
	...
	<div style="height:auto;width:100%;">
		<div style="height:auto;width:100%;align:center" align="center">
			<label style="margin-left:1%;font:bold;font-size:14pt;font-family:arial;font-weight:bold;">Investigations</label>
		</div>
