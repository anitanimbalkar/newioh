			...
			<div class="col-sm-12 col-md-12 no-padding">
				<div class="panel-group" id="accordion">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne1">My EMR</a>
							</h4>
						</div>
							...
							<div class="panel-body">
								<table class="table">
									<tr id="editemr" name="editemr" onmouseover="showstep(0)" onmouseout="hidestep()">
										<td>
											<a onclick="window.location = '/ayushman/cpatienthistorydisplay/view?#/patientemr/<?php echo Auth::instance()->get_user()->id; ?>;uncheckbox();'" href="javascript:void(0);">View / Edit EMR </a>
										</td>
									</tr>
								</table>
							</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo1">My Account</a>
							</h4>
						</div>
							...
							<div class="panel-body">
								<table class="table">
									<tr id="profile" name="profile" onmouseover="showstep(2)" onmouseout="hidestep()">
										<td>
											<a onclick="getcontent('/ayushman/cpatientprofile/displayProfile');uncheckbox();" href="javascript:void(0);"> Edit Profile</a>
										</td>
									</tr>
									<tr id="plan" name="plan" onmouseover="showstep(3)" onmouseout="hidestep()">
										<td>
											<a onclick="getcontent('/ayushman/cplanmanager/showselectedplan');uncheckbox();" href="javascript:void(0);">Choose Plan</a>
										</td>
									</tr>
									<tr>
										<td>
											<a href="javascript:void(0);" onclick="getcontent('/ayushman/cchangepassword/changepassword');uncheckbox();" >Change Password</a>
										</td>
									</tr>
								</table>
							</div>
		...
		<tr>
			<td height="81" align="left" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_Border">
					...
					<tr id="editemr" name="editemr" onmouseover="showstep(0)" onmouseout="hidestep()">
						<td bgcolor="#ffffff" class="bodytext_normal" style="padding-left:10px; padding-top:5px; padding-bottom:7px;"><img src="/ayushman/assets/images/BlueArrow_Icon1.png" width="11" height="8" />&nbsp;&nbsp;&nbsp;<a onclick="window.location = '/ayushman/cpatienthistorydisplay/view?#/patientemr/<?php echo Auth::instance()->get_user()->id; ?>'" href="javascript:void(0);">View / Edit EMR </a></td>
					</tr>-->
				<!--	<tr id="editemr" name="editemr" onmouseover="showstep(0)" onmouseout="hidestep()">
