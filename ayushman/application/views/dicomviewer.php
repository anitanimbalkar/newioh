...
<head>
    ...
    <link href="/ayushman/assets/css/css/font-awesome.min.css" rel="stylesheet">
    <link href="/ayushman/assets/css/style.css" rel="stylesheet" type="text/css"/>
	<link href="/ayushman/assets/css/cornerstone.min.css" rel="stylesheet">
...
<body>
<div id="wrap">
    <input id="reportid" type="hidden" value="<?php echo $reportid;?>"/>
    <div class='main'>
...
<div  class="sectionBox"  style="position:fixed;bottom:0;float:right;right:1px;width:350px">
						<h2 class="orange" style="height:34px;">
							<a data-toggle="collapse" style="" onclick="" data-parent="#accordion" href="/dashboard/#collapseOne" class="collapsed">
								<span class="icons iconNotes" style="color:white;float:left;left:0"> Observations</span> <i class="fa fa-compress" style="color:white;float:right;right:10px;font-size:23px;"></i>
							</a> 
						</h2>
<div id="collapseOne" class="panel-collapse collapse">
							<textarea id="docnotes" class="notesComments contentDetails smallContent" placeholder="Write notes here"  style='resize: none;height:200px;width:100%;' ><?php echo $notes; ?></textarea>
							
							<div class="detailsLink orange">
								 
								<a href="javascript:void(0);" onclick="savenotes();"><span style="color:white;">Save</span></a> 
							</div>
						</div>
				</div>

<script src="/ayushman/assets/js/jquery-2.1.0.min.js"></script>

<!-- include the hammer.js library for touch gestures-->
<script src="/ayushman/assets/js/jquery.hammer-full.js"></script>

<script src="/ayushman/assets/js/bootstrap.min.js" ></script>

<!-- include the cornerstone library -->
<script src="/ayushman/assets/js/cornerstone.min.js"></script>

<!-- include the cornerstone library -->
<script src="/ayushman/assets/js/cornerstoneMath.min.js"></script>

<!-- include the cornerstone tools library -->
<script src="/ayushman/assets/js/cornerstoneTools.min.js"></script>

<!-- include the cornerstoneWADOImageLoader library -->
<script src="/ayushman/assets/js/cornerstoneWADOImageLoader.min.js"></script>

<script src="/ayushman/assets/js/cornerstoneWebImageLoader.min.js"></script>

<!-- include the dicomParser library -->
<script src="/ayushman/assets/js/dicomParser.min.js"></script>

    <script>
	
	$(document).ready(function(){
		var studyViewerCopy = $('#studyViewerTemplate').clone();
		studyViewerCopy.attr("id", 'x' + "2178309");
		studyViewerCopy.removeClass('hidden');
		studyViewerCopy.appendTo('#tabContent');
		loadStudyJson(studyViewerCopy, "ctstudy.json");
	});	
    ...
    function loadStudyJson(studyViewer, studyId)
    {
        ...
        $.getJSON('/ayushman/cdicomviewer/getdicomfiles?reportid='+ reportid, function(data) {
                ...
                if(series.numberOfFrames !== undefined) {
                    ...
                    for(var i=0; i < numberOfFrames; i++) {
					  ...
					  if(imageId.substr(0, 4) !== 'http') {
                            imageId = "dicomwebs://"+window.location.hostname+"/ayushman/" +imageId;
                        }
                    ...
                    series.instanceList.forEach(function(image) {
                        ...
                        if(image.imageId.substr(0, 4) !== 'http') {
                            imageId = "dicomwebs://"+window.location.hostname+"/ayushman/" + image.imageId;
                        }
            ...
            cornerstone.enable(element);console.log(imageId);
