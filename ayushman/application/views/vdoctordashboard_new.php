...
<div class="navbar navbar-inverse navbar-fixed-top" id="topNav" role="navigation">
  <div class="container" id="topHeader">
    ...
    <div class="navbar-header">
      ...
      <div class="logoWrapper" > <a href="#/dashboard/"><img  id="imgLogo" src="/ayushman/assets/images/Logo.png" /></a></div>
	  </div>
...
<!--a href="javascript:void(0);" onClick="hideLeftMenu();" title="Close" class="closeMe">X</a-->
  <ul>
    <li><a data-toggle="collapse" data-parent="#accordion"onclick="hideLeftMenu();" href="#/dashboard/" title="Programs">Home</a></li>
    <li><a data-toggle="collapse" data-parent="#accordion"onclick="hideLeftMenu();" href="#/doctordashboardlanding/" title="Programs">Home2</a></li>
