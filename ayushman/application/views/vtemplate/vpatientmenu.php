		...
		<tr>
			<td height="81" align="left" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_Border">
					...
					<tr>
											<td bgcolor="#ffffff" class="bodytext_normal" style="padding-left:10px; padding-top:5px; padding-bottom:7px;"><img src="/ayushman/assets/images/BlueArrow_Icon1.png" width="11" height="8" />&nbsp;&nbsp;<a  href="javascript:void(0);" onclick="getcontent('/ayushman/cuploadpastvisit/uploadpastprescription');" >View/Upload Prescriptions</a></td>  <!-- Changed Prescription to View/Upload Prescriptions by Ravindra-->
					</tr>
				</table>
			</td>
		</tr>
