...
<!--[if gt IE 8]><!--> <html class="no-js"  ng-app="app"> <!--<![endif]-->
    ...
    <body>
		...
		<input type="hidden" id="reappid" value="<?php echo $rescheduleappid?>">
			<div id="contentDiv" style="height:auto;overflow-y: auto;">	
				<div style="height:auto">							
					<book-Conapp  patient_id="<?php echo $patientid?>" rescheduleappid="<?php echo $rescheduleappid?>" ></book-Conapp>						
				</div>				
			</div>
