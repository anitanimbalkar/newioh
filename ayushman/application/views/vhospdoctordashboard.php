...
<script src="/ayushman/assets/app/js/controllers/admittedpatientsctrl.js"></script>
<script src="/ayushman/assets/app/js/controllers/orderservicesctrl.js"></script>
<script src="/ayushman/assets/app/js/services/ipdpatientsservice.js"></script>
...
<div class="navbar navbar-inverse navbar-fixed-top" id="topNav" role="navigation">
  <div class="container" id="topHeader">
    ...
    <div class="navbar-header">			
      ...
      <div class="logoWrapper" > <a href="#/doctordashboardlanding/"><img  id="imgLogo" src="/ayushman/assets/images/Logo.png" /></a></div>
	  </div>
    <div class="collapse navbar-collapse" xmlns:ng="http://angularjs.org" id="ng-app">
      ...
      <ul id="menubutton"  class="nav navbar-nav" style="margin-left:-10px;">
        <li><a href="javascript:void(0);" title="Menu" class="menudoctor" id="menuExpand" onClick="showLeftMenu();"><i class="fa fa-th-list"></i> </br>Menu</a></li>
      </ul>
		...
		<!--<ul class="nav navbar-nav">
			...
			<!--	<div class="profileDoctor">
                	<img style="height: 50px;" ng-src="{{myprofile['userinfo'].PatientPhoto}}"> 
                </div>-->
                <!--<div class="doctorInformation">
						<p style="padding:0; margin-top:-15px"><img ng-if="presence[myprofile['userinfo'].id]" ng-src="{{'/ayushman/assets/app/img/'+presence[myprofile['userinfo'].id]+'.png'}}"
						style="height:12px;width:12px;border:none;"/> 
						<img ng-if="!(presence[myprofile['userinfo'].id])" ng-src="/ayushman/assets/app/img/offline.png" style="height:15px;width:15px;border:none;"/> <span class="title">Dr.</span> 
						<span class="firstName">{{myprofile['userinfo'].name}}</span>
                </div>
            </div>
		</ul>   -->  
...
<!--a href="javascript:void(0);" onClick="hideLeftMenu();" title="Close" class="closeMe">X</a-->
  <ul>
    <li><a data-toggle="collapse" data-parent="#accordion"onclick="hideLeftMenu();" href="#/doctordashboardlanding/" title="Programs">Home</a></li>
    <li><a data-toggle="collapse" data-parent="#accordion"onclick="hideLeftMenu();" href="#/dashboard/" title="Programs">Old Dashboard</a></li>
    <li><a  href="#/myprofile/" onclick="hideLeftMenu();" title="Doctors">My Profile</a></li>
	<li><a href="#/changepass/" onclick="hideLeftMenu()">Change Password</a></li>
	 <li><a  href="#/personalization/" onclick="hideLeftMenu();" title="Personalization">Personalization</a></li>
	<!--<li><a  href="#/mypatients/" onclick="hideLeftMenu();" title="Doctors">My Patients</a></li>
	<li><a  href="/ayushman/cconsultation/view?#/mydoctors/" onclick="hideLeftMenu();" title="Doctors">My Doctors</a></li>
	<li><a  href="#/staff/" onclick="hideLeftMenu();" title="Doctors">My Staff</a></li>
	<li><a  href="#/chemists/" onclick="hideLeftMenu();" title="My Staff">My Chemists</a></li>
	<li><a  href="#/dc/" onclick="hideLeftMenu();" title="My Staff">My Diagnostic centers</a></li>
	<li><a href="/ayushman/cdoctorclinic/view">My Clinics</a></li>
	<li><a href="/ayushman/cdoctorschedule/view" onclick="hideLeftMenu();">Set Working Hours</a></li>  -->
	<li><a href="#/feemanager/" onclick="hideLeftMenu();">Set Consultation Fees</a></li>
	<li><a href="#/admitted/" onclick="hideLeftMenu();">Admitted Patients</a></li>	
	
    <!--<li><a  href="#/Statements/"onclick="hideLeftMenu();" title="Doctors">Statements</a></li>
    <li><a  href="#/bills/" onclick="hideLeftMenu();"title="Doctors">Bills</a></li>-->
     
	
	
	<!--<li><a href="#/mypackages/" onclick="hideLeftMenu();">My Packages</a></li> 	-->
	<!--<li><a  href="#/recommend/"onclick="hideLeftMenu();" title="Doctors">Send Invite</a></li>-->
  </ul>
...
<p class="bodytext_normalblue" style="margin: 10px;">2. Click  <a href="javascript:void(0)" class="regnbutton" onclick="openremote()">
<i class="fa fa-life-ring" style="  font-size: 17px;"></i> Join Session</a> when asked.</p>
