angular.module('app.controllers')
    .controller('examCtrl',
		['$scope','examReqApi', 'dosageApi','$routeParams','$location','examinationService','formApi','xmppService',
		 function($scope,examReqApi,dosageApi,$routeParams,$location, examinationService, formApi, xmppService) {
