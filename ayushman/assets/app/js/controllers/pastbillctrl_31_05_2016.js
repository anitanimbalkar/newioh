...
//		console.log($scope.myprofile);
	...
	*/
	//$scope.billdate = '';
	$scope.billdate = (new Date()).toString();
	...
	.then(function(data){
					...
					$scope.appointment_info.consultationfee=
					Math.round(Number($scope.appointment_info.amount)
								- Number($scope.billdetail.injection)
					...
					console.log($scope.appointment_info.amount,$scope.billdetail.injection,
								$scope.billdetail.dressing,$scope.billdetail.labtest,
								$scope.billdetail.reconsultation,$scope.billdetail.visit,
								$scope.billdetail.ecg,$scope.billdetail.misc,
								$scope.billdetail.silverfilling,$scope.billdetail.compositefilling,
								$scope.billdetail.rootcanal,$scope.billdetail.periodental,
								$scope.billdetail.oralsurgery,$scope.billdetail.orthodentic,
								$scope.billdetail.metalcapping,$scope.billdetail.ceramiccrown,
								$scope.billdetail.ceramicbridge,$scope.billdetail.metalbridge );
					console.log($scope.appointment_info.consultationfee);		
