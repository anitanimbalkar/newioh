...
.controller('emrCtrl',
['$scope','$http', 'appointmentService','emrService','dashboardService', '$routeParams','createDialog','formApi','examinationService','personalizationService','reportDetailsApi',
function($scope,$http,appointmentService, emrService,dashboardService, $routeParams, createDialogService, formApi,examinationService,personalizationService,reportDetailsApi) {
		...
		if($scope.emr_snapshot['immunizations_details']!=undefined){
			...
			for(var i=0; i<$scope.emr_snapshot['immunizations_details'].length;i++ ){
				...
				$scope.changedQuestions['immunizations_details'][immunizationdate] =  $scope.emr_snapshot['immunizations_details'][i][1];
						...
						$scope.forms = data;						
						$scope.spe = $scope.forms.selectedhistoryform;
...
function($scope, appointmentService,dosageApi,formApi,emrService,examinationService) {
	...
	if(appointment_data.examination != undefined){
		...
		if(appointment_data.examination.vitals != undefined && appointment_data.examination.vitals.vitals_q_3 != undefined){
			$scope.previousexamination_data.vitals_q_3 = appointment_data.examination.vitals.vitals_q_3.a;
			$scope.previousexamination_data.isexaminationavailable = true;
		}
		if(appointment_data.examination.vitals != undefined && appointment_data.examination.vitals.vitals_q_41 != undefined){
			$scope.previousexamination_data.vitals_q_41 = appointment_data.examination.vitals.vitals_q_41.a;
			$scope.previousexamination_data.isexaminationavailable = true;
		}
		if(appointment_data.examination.vitals != undefined && appointment_data.examination.vitals.vitals_q_42 != undefined){
			$scope.previousexamination_data.vitals_q_42 = appointment_data.examination.vitals.vitals_q_42.a;
			$scope.previousexamination_data.isexaminationavailable = true;
		}
		if(appointment_data.examination.vitals != undefined && appointment_data.examination.vitals.vitals_q_43 != undefined){
			$scope.previousexamination_data.vitals_q_43 = appointment_data.examination.vitals.vitals_q_43.a;
			$scope.previousexamination_data.isexaminationavailable = true;
		}
		if(appointment_data.examination.vitals != undefined && appointment_data.examination.vitals.vitals_q_11 != undefined){
			$scope.previousexamination_data.vitals_q_11 = appointment_data.examination.vitals.vitals_q_11.a;
			$scope.previousexamination_data.isexaminationavailable = true;
		}
