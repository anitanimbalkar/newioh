 ...
 * @license MIT
 */
 //angular.module('agGrid.services').factory('$domUtilityService',['$utilityService',
  (function($utils) {

var utils_1 = require('../utils');
var BorderLayout = (function () {
   domUtilityService.BorderLayout= function(params) {
    ...
    console.log("BorderLayout",BorderLayout);
    return BorderLayout;
})();
//]);
